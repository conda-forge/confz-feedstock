...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/confz-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14946&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/confz-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `confz` can be installed with:

```
conda install confz
```

It is possible to list all of the versions of `confz` available on your platform with:
